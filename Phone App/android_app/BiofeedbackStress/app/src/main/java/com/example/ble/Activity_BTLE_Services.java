...
public class Activity_BTLE_Services extends AppCompatActivity implements ExpandableListView.OnChildClickListener
{
    ...
    public static final String EXTRA_NAME = "com.example.ble.Activity_BTLE_Services.NAME";
    public static final String EXTRA_ADDRESS = "com.example.ble.Activity_BTLE_Services.ADDRESS";

    ListAdapter_BTLE_Devices expandableListAdapter;
    ...
    private ServiceConnection mBTLE_ServiceConnection = new ServiceConnection()
    {
        ...
        {
            // Bound to LocalService, cast IBinder and obtain LocalService instance
