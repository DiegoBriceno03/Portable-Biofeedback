...
import com.example.ble.Service_BTLE_GATT;
...
// Goal of reducing overall clutter in the hierarchy. Implements many functions
// that other files may need to access.
public class Utils
{
    public static boolean checkBluetooth(BluetoothAdapter bluetoothAdapter)
    {
        // Ensures Bluetooth is available on device and is enabled. If not,
